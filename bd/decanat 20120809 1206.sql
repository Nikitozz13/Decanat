...
INSERT INTO `people` (`id`,`first_name`,`last_name`,`birthday`,`sex`) VALUES 
 ...
 (31,'Им','Фам','2021-01-17','М'),
 (33,'Имяяя','Фамил','2021-07-17','М');
...
INSERT INTO `students` (`id`,`personal_number`,`person_id`) VALUES 
 (1,111,1),
 (2,222,2),
 (3,333,3),
 (4,123,5),
...
INSERT INTO `users` (`id`,`username`,`password`,`secretary_id`) VALUES 
 (3,'ивтсекретарь','a86ac259f2724431415e65c8c3ce60e40621cf30',4),
 (5,'хгсекретарь','a86ac259f2724431415e65c8c3ce60e40621cf30',6);
